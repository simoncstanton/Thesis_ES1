...
python3 -m run_exp.exp_symmetric_selfplay -j $PBS_JOBID -w $SCRATCH_DIR -g g111 -r ordinal -s watkins_q_lfa -e 1 -t 100000 -p 'na' -k true -z true -c true -l false -v true

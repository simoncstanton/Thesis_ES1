#!/usr/bin/env python3
# file: obs_compile_exp_summary_tournament.py
'''
    obs_compile_exp_summary_tournament
        - create obs_id
        ...
        usage: python -m obs_compile_exp_summary_tournament -j __STR__ -l true
'''
...
def main(argv):
    ...
    obs_utility().set_obs_data_start_tournament(obs_data)

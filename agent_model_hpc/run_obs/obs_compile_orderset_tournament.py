#!/usr/bin/env python3
'''
    Specific orderset processing for tournament
...
from run_obs.orderset_components import obs_compile_exp_summary_tournament as exp_summary

from run_obs.orderset_components import obs_compile_exp_episode_outcomes_tournament as ep_outcomes
from run_obs.orderset_components import obs_compile_exp_episode_rewards_tournament as ep_rewards

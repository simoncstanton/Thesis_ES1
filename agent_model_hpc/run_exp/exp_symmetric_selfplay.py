...
def parse_input(exp_data, argv):
    ...
    try:
        options, args = getopt.getopt(argv, "hj:w:s:f:g:r:e:t:p:k:z:c:l:v:", ["pbs_jobstr", "pbs_scratch_dir", "strategy", "family", "gameform", "reward_type", "episodes", "timesteps", "parameter_string", "write_state", "compress_writes", "write_2_heartbeats", "localhost", "verbose"])
